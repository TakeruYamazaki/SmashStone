...
{
	D3DXVECTOR3(520.0f, SCREEN_HEIGHT / 2, 0.0f),
	D3DXVECTOR3(810.0f, SCREEN_HEIGHT / 2, 0.0f),
...
void CUIKO::Update(void)
{
	...
	if (m_nCntFase == KOUI_MAX && m_nCntAny == TIME_ZOOM_KO)
	{
		CGame *pGame = CManager::GetRenderer()->GetGame();
		pGame->SetGameState(CGame::GAMESTATE_END);
	}
}
